...
class STTService {
    fun computeTax(esopType: String, quantity: Long, price: Long): Long {
        ...
        return if (esopType == "NON_PERFORMANCE") {
            calculateTaxForNonPerformanceESOP(quantity, price)
        } else {
            calculateTaxForPerformanceESOP(quantity, price)
        }
    }

    private fun calculateTaxForPerformanceESOP(quantity: Long, price: Long) = when {
    ...
    private fun calculateTaxForNonPerformanceESOP(quantity: Long, price: Long) = when {
